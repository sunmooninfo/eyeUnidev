<template>
	<view>
		<view class="wm-numbox">
			...
			<view :class="['wm-numbox_btn',model==2?'wm-numbox_radio_p':'wm-numbox_plus',inputValue >= max?'numbox_disabled':'']" hover-class="Number_hover" :style="{width:height+'px',height:height+'px',lineHeight:height-3+'px',fontSize:height-5+'px'}" @click="Plus">+</view>
		</view>
