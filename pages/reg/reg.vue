...
<view class="container">
    ...
    <view class="dialog" @click="show_log" v-if="showDialog">
        <scroll-view class="protocol_info" scroll-y="true">
            <h3>付费知识平台用户注册协议</h3>
            <view class="pop_view">
                在此特别提醒您在注册成为付费知识平台用户之前,请认真阅读本《付费知识平台用户注册协议》(以下简称“协议”),确保您充分理解本协议中各条款。请您审慎阅读并选择接受或不接受本协议。您同意并点击确认本协议条款且完成注册程序后,才能成为付费知识平台的正式注册用户,并享受付费知识平台的各类服务。您的注册、登录、使用等行为将视为对本协议的接受,并同意接受本协议各项条款的约束。若您不同意本协议,或对本协议中的条款存在任何疑问,请您立即停止付费知识平台用户注册程序,并可以选择不使用付费知识平台服务。本协议条款是付费知识平台公司（以下称“付费知识平台”或“我们”）对用户相关政策的许诺,请您务必仔细阅读。
            </view>
            ...
            <view class="pop_view">
                付费知识平台信息所收集您的个人信息，将仅用于付费知识平台为您提供相关服务。一般情况下，在未得到您的同意之前，您的任何个人信息将不会被提供给无关的第三方。
            </view>
            <view class="pop_view">
            ...
            <view class="pop_view">
                (9)含有法律、行政法规禁止的其他内容或违反付费知识平台的其他规定的。
            </view>
            <view class="pop_view">
                用户以虚假信息骗取帐号名称注册,或其帐号头像、简介等注册信息存在违法和不良信息的,付费知识平台有权采取通知限期改正、暂停使用、注销登记等措施。付费知识平台帐号仅限于用户本人使用,严禁将您的付费知识平台帐号允许第三人使用,否则用户应承担由此产生的全部责任,并与实际使用人承担连带责任
            </view>
            <view class="pop_view"> 5. 信息安全 </view>
            <view class="pop_view">
                您的本网站/软件帐户信息和本网站/软件档案通过密码来保护，只有您个人才有权获取这些个人信息。我们建议您不要向任何他人泄露您的密码。本网站/软件也不会主动致电或主动发电子邮件给您来询问您的密码，如果您遇到此类情况请及时与付费知识平台客服联系确认。同时，请您在完成工作后，务必退出您的本网站/软件帐户并关闭您的浏览器窗口，以便当您与他人合用一台电脑，或正在公共场所使用电脑时，保证他人无法获取您的个人信息和往来通信。遗憾的是，任何通过互联网或无线网络的数据传输都无法获得绝对的安全保证。所以，在我们尽最大努力来保护您的个人信息的同时，本网站/软件不能对您向我们进行的信息传输，或我们所发的在线产品或服务的信息的安全作出肯定或保证。您作出上述行为时将自己承担风险。一旦我们收到您传输来的信息，我们将尽最大努力保证其在我们系统的安全。
            </view>
            <view class="pop_view"> 6. 用户隐私制度 </view>
            <view class="pop_view">
                我们会在您自愿的前提下收集您的个人信息并将这些信息进行整合,包括但不限于注册
                帐号时的相关信息和活动报名信息等。尊重用户个人隐私是付费知识平台的一项基本政策。所以,付费知识平台不会公开或向任何第三方透露用户的注册资料以及用户因享受付费知识平台服务而提供的任何信息,但以下情形除外:
            </view>
            ...
            <view class="pop_view">
                (4)根据本条款相关规定或者付费知识平台认为必要的其他情形。付费知识平台可能会与第三方合作向用户提供相关的网络服务,在此情况下,如该第三方同意承担与付费知识平台同等的保护用户隐私的责任,则付费知识平台可将用户信息提供给该第三方。
            </view>
            <view class="pop_view"> 7. 所有权及知识产权条款 </view>
            <view class="pop_view">
                本“网站/软件”由付费知识平台拥有和运作。本“网站/软件”公开或显示的所有内容，包括但不限于文字、图表、照片、图像、动画、音效、插图及软件（简称“内容”）等，均属付费知识平台及其许可人或内容供应商所有。本“网站/软件”内的所有组成要素，包括但不限于整体设计及“内容”，均受商业外观、版权、道德规范、商标及其它所有相关知识产权的法律保护。除非依据本条款与条件或与经付费知识平台在其它协议的声明同意外，本网站/软件內的任何部分或组成要素或“內容”均不得以任何方式复制或传播。除非有明确协议同意，否则网站/软件中的“內容”及一切相关权利将为付费知识平台成员或其许可人的资产。
            </view>
            ...
            <view class="pop_view">
                客户明确同意使用付费知识平台服务的风险由客户承担。付费知识平台明确表示不提供任何类型的担保，不论是明确的或隐含的。付费知识平台将尽力维护客户使用付费知识平台服务的合法权益，但不担保付费知识平台服务一定能满足客户的要求，也不担保服务的及时性、安全性、真实性、稳定性、正确性。对客户使用该等服务中出现的信息（包括但不限于客户发布的信息）删除或储存失败，付费知识平台亦不承担任何责任。
                客户理解并接受下载或通过相应产品服务取得的任何信息资料取决于客户自己，并自行承担系统受损、资料丢失以及其他任何风险。付费知识平台对客户在互联网上得到的任何商品购物服务、交易进程、招聘信息等，都不作担保。
                付费知识平台对直接、间接、偶然、特殊及继起的损害不负责任，这些损害来自：不正当使用付费知识平台服务及/或应用服务，在网上购买商品或类似服务，在网上进行交易，非法使用服务或客户传送的信息有所变动。
                付费知识平台对本项服务下涉及的境内外基础运营商的通信网络的故障、技术缺陷、覆盖范围限制、不可抗力、计算机病毒、黑客攻击、客户所在位置、客户关机或其他非付费知识平台技术能力范围内的事因等造成的服务中断、客户邮件内容丢失、出现乱码、错误接收、无法接收、迟延接收不承担责任。
                付费知识平台保留判定客户的行为是否符合本服务协议要求的权利，如果客户违背了本服务协议的规定，付费知识平台有权中止或终止相应付费知识平台服务。
                转户规定：如果客户将手机号码转让给他人，请用户提前自行删除付费知识平台内资料。否则，受让该号码的客户将能够查看您的客户个人数据。付费知识平台不承担由此引发的客户数据丢失等责任及纠纷。
            </view>
            ...
            <view class="pop_view">
                我们尊重用户和消费者的合法权利,本用户协议及本站上发布的各类规则、政策、声明等其他内容,均是为了更好的、更加便利的为用户和消费者提供服务。付费知识平台欢迎用户和社会各界提出意见和建议,我们将虚心接受并适时修改本服务条款及相关政策、规则。
            </view>
            <view class="pop_view">
                您完成注册且成为付费知识平台的注册用户则意味着您完全接受本用户协议,在注册之前请您再次确认已知悉并完全理解本用户协议的全部内容。
            </view>
        </scroll-view>
    </view>
</view>
