...
<view class="container">
    ...
    <view class="middle">
        <view class="blod_text">{{ checkName }}</view>
    </view>
    <view class="bottom">
            ...
            this.$request
                ...
                .then((res) => {
                    ...
                    for (let i = 0; i < this.navList.length; i++) {
                        if (this.navList[i].id == this.nav_click) {
                            this.navActive = this.navList[i].id;
							this.checkName = this.navList[i].name
                            break;
                        }
                    }
                    if (this.nav_click != this.navActive) {
                        this.nav_click = this.navList[0].id;
						this.checkName = this.navList[0].name
                    }
                    this.page = 1;
                    this.goodsList = [];
                    this.getGoodsList();
